...
class TestAppConfig:
    ...
    def test_defaults(self):
        ...
        # Both required, so read back from the env defaults conftest.py seeds,
        # not from field defaults - neither bucket has one.
        assert cfg.source_docs_s3_bucket == "rpa-ai-guidance-hub-source-docs"
        assert cfg.docs_s3_bucket == "rpa-ai-guidance-hub-docs"
